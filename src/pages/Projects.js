  ...
  const projects = [
    {
      ...
      shortDescription: process.env.PUBLIC_URL + '/images/Todoist.png',
    ...
    },
    {
      ...
      shortDescription: process.env.PUBLIC_URL + '/images/Investments.png', 
      fullDescription: language === 'es'
    ...
    <section className="projects">
      ...
      <div className="shared-section">
        {projects.map((project, index) => (
          ...
          >
            <p className="shared-item-title">{project.title}</p>
            {expandedIndex !== index && (
